...
int main(void)
{
    ...
    if (count == 16)
    {
        ...
        {
            printf("Your card is a Mastercard card. The last number is %i. The second to last number is %i. Fourth to last is %i. Sixth to last is %i. Eighth to last is %i. Tenth to last is %i. Twelfth to last is %i. Fourteenth to last is %i. Sixteenth to last is %i.\n", last_number, second_to_last_number, fourth_to_last_number, sixth_to_last_number, eighth_to_last_number, tenth_to_last_number, twelfth_to_last_number, fourteenth_to_last_number, sixteenth_to_last_number);
            return card_number;
        }
